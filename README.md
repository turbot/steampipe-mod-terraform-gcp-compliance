...
- Pass in a value on the command line:
  ...
  ```shell
  steampipe check benchmark.bigquery --var 'common_dimensions=["connection_name", "path"]'
  ```
...
- Set an environment variable:
  ...
  ```shell
  SP_VAR_common_dimensions='["connection_name", "path"]' steampipe check control.bigquery_dataset_encrypted_with_cmk
  ```

  ```shell
  SP_VAR_tag_dimensions='["Environment", "Owner"]' steampipe check control.bigquery_dataset_encrypted_with_cmk
  ```
